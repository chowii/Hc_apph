...
public class SettingsAdapter extends FlexibleAdapter<AbstractSectionableItem> {
    ...
    public SettingsAdapter(Context context, View.OnClickListener onClickListener, SwitchItemListener switchListener, boolean notificationsEnabled) {
    ...
    private List<AbstractSectionableItem> createSettingsItems() {
        ...
        items.add(new SettingsSwitchItem(settingsHeader, "Push Notifications", mNotificationsEnabled, "receive_push_notifications", mSwitchListener));
        items.add(new SettingsItem(settingsHeader, "Alerts", NavHelper.webViewActivityIntent(mContext, Constants.Urls.faq)));
